...
in
{
  ...
  home = {
    ...
    programs.starship.settings = builtins.fromTOML ''
      ...
      [using](italic fg:${colors.base08}) $shlvl$shell \
      [\\(](bold fg:${colors.cyan}) \
      $aws\
      $azure\
      $gcloud\
      ...
      [in](italic fg:${colors.base08}) $directory\
      ...
      [time]
      format = "[at](italic fg:${colors.base08}) [$time]($style) "
      style = "bold fg:${colors.blue}"
      disabled = false

      [cmd_duration]
      min_time = 1
      format = "[took](italic fg:${colors.base08}) [$duration]($style)"
      disabled = false
      ...
      [git_branch]
      format = "[on](italic fg:${colors.base08}) [$symbol $branch]($style)"
      style = "bold fg:${colors.blue}"
      symbol = ""
